...
import picExp from '../../assets/Expic1.jpg'
import picExp2 from '../../assets/Expic2.jpg'
        ...
        <div className="">
            ...
            >
                ...
                <div className="grid gap-y-4">
                    <TitleLink isHighlight={isMouseEnter['exp1']} title="Fullstack" link="https://github.com/KUYYAWMAK/reaweb.git" />
                    <div className="flex gap-4 text-xl" >
                        <Material icon={faGithub} link="https://github.com/KUYYAWMAK/reaweb.git" />
                        <Material icon={faYoutube} link="https://www.youtube.com/@84kcellss65" />
                    </div>
